		...
		<div class="col-md-12 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#areaInfoListPanel" aria-controls="areaInfoListPanel" role="tab" data-toggle="tab">物品所在区域信息列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>AreaInfo/areaInfo_frontAdd.jsp" style="display:none;">添加物品所在区域信息</a></li>
				</ul>
			  	<!-- Tab panes -->
				    				...
				    				<table class="table table-condensed table-hover">
				    					...
				    					<% 
				    	            		...
				    	            		for(int i=0;i<areaInfoList.size();i++) {
					    	            		...
					    	            		AreaInfo areaInfo = areaInfoList.get(i); //获取到物品所在区域信息对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;物品所在区域信息信息编辑</h4>
      </div>
