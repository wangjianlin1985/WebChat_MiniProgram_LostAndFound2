		...
		<div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	<li role="presentation" ><a href="<%=basePath %>PriceRegion/frontlist">物品的价格区间列表</a></li>
			    	<li role="presentation" class="active"><a href="#priceRegionAdd" aria-controls="priceRegionAdd" role="tab" data-toggle="tab">添加物品的价格区间</a></li>
				</ul>
				<!-- Tab panes -->
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="priceRegionAdd"> 
						  ...
						  <div class="form-group">
						  	 <label for="priceRegion_regionName" class="col-md-2 text-right">物品的价格区间:</label>
						  	 <div class="col-md-8">
							    <input type="text" id="priceRegion_regionName" name="priceRegion.regionName" class="form-control" placeholder="请输入物品的价格区间">
							 </div>
						  </div>
				          <div class="form-group">
