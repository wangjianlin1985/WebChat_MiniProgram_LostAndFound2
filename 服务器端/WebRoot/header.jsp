    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>ProductClass/frontlist">失物招领分类</a></li>
                <li><a href="<%=basePath %>ProductInfo/frontlist">失物招领信息</a></li>
                <li><a href="<%=basePath %>PriceRegion/frontlist">物品的价格区间</a></li>
                <li><a href="<%=basePath %>NewOldLevel/frontlist">物品新旧程度</a></li>
                <li><a href="<%=basePath %>AreaInfo/frontlist">物品所在区域信息</a></li>
