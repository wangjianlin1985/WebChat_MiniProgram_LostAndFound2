		...
		<div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	<li role="presentation" ><a href="<%=basePath %>AreaInfo/frontlist">物品所在区域信息列表</a></li>
			    	<li role="presentation" class="active"><a href="#areaInfoAdd" aria-controls="areaInfoAdd" role="tab" data-toggle="tab">添加物品所在区域信息</a></li>
				</ul>
				<!-- Tab panes -->
