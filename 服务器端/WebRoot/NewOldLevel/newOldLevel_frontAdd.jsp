		...
		<div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	<li role="presentation" ><a href="<%=basePath %>NewOldLevel/frontlist">物品新旧程度列表</a></li>
			    	<li role="presentation" class="active"><a href="#newOldLevelAdd" aria-controls="newOldLevelAdd" role="tab" data-toggle="tab">添加物品新旧程度</a></li>
				</ul>
				<!-- Tab panes -->
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="newOldLevelAdd"> 
						  ...
						  <div class="form-group">
						  	 <label for="newOldLevel_levelName" class="col-md-2 text-right">物品新旧程度:</label>
						  	 <div class="col-md-8">
							    <input type="text" id="newOldLevel_levelName" name="newOldLevel.levelName" class="form-control" placeholder="请输入物品新旧程度">
							 </div>
						  </div>
				          <div class="form-group">
