		...
		<div class="col-md-12 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#productClassListPanel" aria-controls="productClassListPanel" role="tab" data-toggle="tab">失物招领分类列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>ProductClass/productClass_frontAdd.jsp" style="display:none;">添加失物招领分类</a></li>
				</ul>
			  	<!-- Tab panes -->
				    				...
				    				<table class="table table-condensed table-hover">
				    					...
				    					<% 
				    	            		...
				    	            		for(int i=0;i<productClassList.size();i++) {
					    	            		...
					    	            		ProductClass productClass = productClassList.get(i); //获取到失物招领分类对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;失物招领分类信息编辑</h4>
      </div>
